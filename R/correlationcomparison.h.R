...
correlationComparisonResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    ...
    active = list(
        comparisonInfo = function() private$.items[["comparisonInfo"]],
...
#' \tabular{llllll}{
#'   \code{results$comparisonInfo} \tab \tab \tab \tab \tab a html \cr
