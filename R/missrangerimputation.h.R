...
missRangerImputationOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
        ...
        initialize = function(
            ...
            private$..predictor_vars <- jmvcore::OptionVariables$new(
                ...
                permitted=list(
                    ...
                    "factor"),
                default=NULL)
            private$..use_multiple_imputation <- jmvcore::OptionBool$new(
                "use_multiple_imputation",
                use_multiple_imputation,
                default=FALSE)
            ...
            self$.addOption(private$..use_multiple_imputation)
    ...
    active = list(
        ...
        use_multiple_imputation = function() private$..use_multiple_imputation$value,
...
missRangerImputation <- function(
    ...
    options <- missRangerImputationOptions$new(
        ...
        use_multiple_imputation = use_multiple_imputation,
